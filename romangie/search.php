	...
	<div class="row">
		...
		<?php if (have_posts()) : ?>
            ...
            <div id="title_archives" class="entry-title">
				...
				<h1 class="page-title"><?php printf( __( 'Résultats pour : %s', 'twentythirteen' ), get_search_query() ); ?></h1>
...
<div class="col-sm-3 meta info hidden-xs">
            ...
            <?php $romangie_countComments = wp_count_comments(get_the_ID()); ?>
				<article id="post-<?php the_ID(); ?>" <?php post_class('row post-roll'); ?>>
				<div class="<?php echo $romangie_content_class; ?>">
				<h2><?php _e('Nothing Found', 'romangie' ); ?></h2>
                <div class="entry"></div>
                </div>
                </article>
			...
			<div class="pagenav page-links row">
				<?php /*?><div class="next-posts pagination-item col-xs-6 col-sm-offset-3 col-sm-4"><?php next_posts_link('&laquo; ' . __('Older Entries', 'romangie') ) ?></div>
				<div class="prev-posts pagination-item col-xs-6 col-sm-offset-1 col-sm-4"><?php previous_posts_link( __('Newer Entries', 'romangie') . ' &raquo;') ?></div> <?php */?>
